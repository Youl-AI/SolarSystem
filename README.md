...
저장 공간은 클론에 3.4 GB(작업 트리 1.7 GB + git 히스토리 1.7 GB), 빌드 산출물과
의존성 소스에 1 GB 남짓입니다. 텍스처가 이미 압축된 `.dds`라 git이 더 줄이지 못합니다.
히스토리가 필요 없다면 `git clone --depth 1`로 절반을 아낄 수 있습니다.
