...
```bash
git clone https://github.com/Youl-AI/Ephemeris.git
cd Ephemeris
...
> [Release](https://github.com/Youl-AI/Ephemeris/releases/tag/textures-v1)에 첨부해
...
**[itch.io](https://pianocchio.itch.io/solarsystem)에서 zip으로 받으시면 됩니다.**
빌드된 실행 파일과 텍스처가 전부 들어 있어서, 압축을 풀고 `Ephemeris.exe`를 실행하면
끝입니다 — Vulkan SDK 설치도, 텍스처 내려받기도 필요 없습니다.
(폴더 구조는 그대로 두세요. 위와 같은 이유로 상대 경로를 씁니다.)
